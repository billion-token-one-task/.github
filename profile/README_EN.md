...
1. **Browse** — explore our repos and open research proposals
2. **Propose** — submit a research direction using our [proposal template](PROPOSAL_TEMPLATE_EN.md)
3. **Contribute** — pick a project, open an issue, start a conversation
4. **Sign** the [Contributor License Agreement (CLA)](CLA.md) before your first contribution

We welcome collaborators from universities, research labs, and the open-source community.
